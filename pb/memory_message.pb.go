...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=grpc.practices.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x69, 0x63, 0x65, 0x73, 0x22, 0xaf, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x61,
	0x63, 0x74, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: grpc.practices.Memory.Unit
	(*Memory)(nil),   // 1: grpc.practices.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpc.practices.Memory.unit:type_name -> grpc.practices.Memory.Unit
