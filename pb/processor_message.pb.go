...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x67, 0x72, 0x70, 0x63, 0x2e,
	0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: grpc.practices.CPU
	(*GPU)(nil),    // 1: grpc.practices.GPU
	(*Memory)(nil), // 2: grpc.practices.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: grpc.practices.GPU.memory:type_name -> grpc.practices.Memory
