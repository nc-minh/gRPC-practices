...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=grpc.practices.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72,
	0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f,
	...
	0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x67, 0x72, 0x70, 0x63,
	0x2e, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61,
	...
	0x0b, 0x32, 0x16, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: grpc.practices.Storage.Driver
	(*Storage)(nil),     // 1: grpc.practices.Storage
	(*Memory)(nil),      // 2: grpc.practices.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: grpc.practices.Storage.driver:type_name -> grpc.practices.Storage.Driver
	2, // 1: grpc.practices.Storage.memory:type_name -> grpc.practices.Memory
